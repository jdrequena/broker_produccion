      ...
      <sch:BasicReverseRequest>
         <ns4:basicRequest>
            <externalApplicationID>
               <xsl:value-of select="/sch:BasicReverseRequest/ns4:basicRequest/externalApplicationID"/>
            </externalApplicationID>
            <externalTransactionID>
               <xsl:value-of select="/sch:BasicReverseRequest/ns4:basicRequest/externalTransactionID"/>
            </externalTransactionID>
            <utiReference>
               <xsl:value-of select="/sch:BasicReverseRequest/ns4:basicRequest/utiReference"/>
            </utiReference>
         </ns4:basicRequest>
      </sch:BasicReverseRequest>
   </xsl:template>
